  ...
  return (
    <div class="about section" id="introduction">
      ...
      <p class="about__text">
          ...
          the CMS Software<sup><a href="#ref1">[1]</a></sup> (CMSSW) to fully exploit the granularity and other significant detector features, such as particle identification and precision timing,
